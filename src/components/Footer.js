                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-2">
                            ...
                            <ul>
                                ...
                                <li>
                                    <h6>Delivery Terms &amp; Conditions</h6>
                                </li>
                                <li>
                                    <h6>Tracking</h6>
                                </li>
                            ...
                            <ul className="instagram-photos">
                                <li>
                                    <div className="view overlay hm-white-slight z-depth-1">
                                        <img className="img-fluid" src="http://mdbootstrap.com/img/Photos/Avatars/img%20(9).jpg" alt="Ảnh" />
                                            <div className="mask waves-light waves-effect waves-light"></div>
                                    </div>
                                </li>
                                <li>
                                    <div className="view overlay hm-white-slight z-depth-1">
                                        <img className="img-fluid" src="http://mdbootstrap.com/img/Photos/Avatars/img%20(20).jpg" alt="Ảnh" />
                                            <div className="mask waves-light waves-effect waves-light"></div>
                                    </div>
                                </li>
                                <li>
                                    <div className="view overlay hm-white-slight z-depth-1">
                                        <img className="img-fluid" src="http://mdbootstrap.com/img/Photos/Avatars/img%20(19).jpg" alt="Ảnh" />
                                            <div className="mask waves-light waves-effect waves-light"></div>
                                    </div>
                                </li>
                                <li>
                                    <div className="view overlay hm-white-slight z-depth-1">
                                        <img className="img-fluid" src="http://mdbootstrap.com/img/Photos/Avatars/img%20(16).jpg" alt="Ảnh" />
                                            <div className="mask waves-light waves-effect waves-light"></div>
                                    </div>
                                </li>
                                <li>
                                    <div className="view overlay hm-white-slight z-depth-1">
                                        <img className="img-fluid" src="http://mdbootstrap.com/img/Photos/Avatars/img%20(5).jpg" alt="Ảnh" />
                                            <div className="mask waves-light waves-effect waves-light"></div>
                                    </div>
                                </li>
                                <li>
                                    <div className="view overlay hm-white-slight z-depth-1">
                                        <img className="img-fluid" src="http://mdbootstrap.com/img/Photos/Avatars/img%20(18).jpg" alt="Ảnh" />
                                            <div className="mask waves-light waves-effect waves-light"></div>
                                    </div>
                                </li>
                                <li>
                                    <div className="view overlay hm-white-slight z-depth-1">
                                        <img className="img-fluid" src="http://mdbootstrap.com/img/Photos/Avatars/img%20(15).jpg" alt="Ảnh" />
                                            <div className="mask waves-light waves-effect waves-light"></div>
                                    </div>
                                </li>
                                <li>
                                    <div className="view overlay hm-white-slight z-depth-1">
                                        <img className="img-fluid" src="http://mdbootstrap.com/img/Photos/Avatars/img%20(17).jpg" alt="Ảnh" />
                                            <div className="mask waves-light waves-effect waves-light"></div>
                                    </div>
                                </li>
                            </ul>
